...
tab_01 = data.frame(
  Name = c("configural.a", "weak.a", "strong.a", "strict.a"),
  Df = c("528", "573", "618", "672"),
  AIC = c("13,645.98", "13,614.45", "13,569.48", "13,538.35"),
  BIC = c("14,453.38", "14,262.50", "14,058.18", "13,835.82"),
  Chisq = c("1,117.59", "1,176.06", "1,221.09", "1,297.96"),
  `Chisq diff` = c("NA","58.48","45.03","76.87"),
  `Df diff` = c("NA", "45", "45", "54"),
  `Pr(>Chisq)` = c("NA", "0.09", "0.47", "0.02")
)
...
kable(
  ...
  escape = FALSE,
  longtable = TRUE,
  col.names = c("","Df", "AIC", "BIC", "Chisq", "Chisq diff", "Df diff", "Pr (>Chisq)"),
  align = c("l","c", "c", "c","c", "c", "c", "c", "c", "c"),
  caption = "Measurement invariance summary statitics (attudinal structure)") %>%
