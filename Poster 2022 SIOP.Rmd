...
```{r semplotsub, fig.cap="Omnibus Confirmatory Factor Analysis substantive structure.", out.width="100%"}
knitr::include_graphics("image1.svg", dpi = 1000)
```

```{r semplotatt, fig.cap="Omnibus Confirmatory Factor Analysis attitudinal structure.", out.width="100%"}
