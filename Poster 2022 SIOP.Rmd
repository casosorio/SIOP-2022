...
```{r semplotsub, fig.cap="Omnibus Confirmatory Factor Analysis substantive structure.", out.height="80%", fig.align ='center', out.width= "90%"}
knitr::include_graphics("image1.svg", dpi = 1000)
``` 

```{r semplotatt, fig.cap="Omnibus Confirmatory Factor Analysis attitudinal structure.", out.height="80%", fig.align= 'center', out.width= "90%"}
